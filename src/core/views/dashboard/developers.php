<?php $this->beginContent('@app/core/views/layouts/sidebar/_nav-developers.php');
    ...
    <div class="wallet-content-item">
        <div class="container-fluid">
                <div class="balance-area">
                    ...
                    <pre><?=Yii::$app->user->identity->getFirstAccessKeyByRole(\lnpay\core\behaviors\UserAccessKeyBehavior::ROLE_PUBLIC_API_KEY);?></pre>
                    <h3>Secret API Key (to be used server side only!)</h3>
                    <pre><?=Yii::$app->user->identity->getFirstAccessKeyByRole(\lnpay\core\behaviors\UserAccessKeyBehavior::ROLE_SECRET_API_KEY);?></pre>
                    <br/>
