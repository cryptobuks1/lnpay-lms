...
use lnpay\core\assets\PaywallAsset;
use lnpay\core\widgets\Alert;
...
<div class="wrap">
    ...
    $menuItemsLeft = [
        ...
        [
            ...
            'active'=>\lnpay\core\components\HelperComponent::str_contains(Yii::$app->request->pathInfo,['node/']),
            'encode'=>false,
        ],
        [
            'label' => '<img src="/img/icons/flowchart.svg" style="width:15px" /> Developers',
            'url' => (Yii::$app->user->isGuest?'#':['/developers/dashboard']),
            'active'=>\lnpay\core\components\HelperComponent::str_contains(Yii::$app->request->pathInfo,['developers','webhook']),
            'encode'=>false,
        ],
    ];
