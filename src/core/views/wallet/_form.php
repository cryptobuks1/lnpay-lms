...
/* @var $model lnpay\core\models\wallet\Wallet */
...
<div class="wallet-form">
    ...
    $types = \yii\helpers\ArrayHelper::map(\lnpay\core\models\wallet\WalletType::getAvailableWalletTypes(),'id','display_name');
