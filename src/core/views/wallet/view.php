...
?>
<?php $this->beginContent('@app/core/views/layouts/sidebar/_nav-wallets.php',compact('wallet')); ?>
...
<div class="collapse" id="deposit-details" style="margin-top: 25px;">
    ...
    <div class="wallet-content-item row" style="padding: 25px; margin-bottom: 12px; box-shadow: 0 1px 3px hsla(0, 0%, 0%, .2);">
        <div class="col-md-6">
            ...
            <?php
                $key = $wallet->getFirstAccessKeyByRole(\lnpay\core\behaviors\UserAccessKeyBehavior::ROLE_WALLET_INVOICE);
                $userKey = Yii::$app->user->identity->getFirstAccessKeyByRole(\lnpay\core\behaviors\UserAccessKeyBehavior::ROLE_PUBLIC_API_KEY);
               $this->registerJs("
