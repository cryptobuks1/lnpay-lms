...
/* @var $model lnpay\core\models\integration\IntegrationWebhook */
...
<div class="integration-webhook-form col-md-12 well">
    ...
    <?php
        ...
        $actions = \lnpay\core\models\action\ActionName::getActiveWebhookArrayByType();
    ...
    <?php  echo $form->field($model, 'status_type_id')->dropDownList(\yii\helpers\ArrayHelper::map(\lnpay\core\models\StatusType::getAvailableStatuses(\lnpay\core\models\StatusType::TYPE_WEBHOOK),'id','display_name')); ?>
...
<?php if ($model->id) { ?>
    <div class="integration-webhook-form col-md-6 well">
        <?php
        $webhookTestForm = new \lnpay\core\models\integration\WebhookTestForm();
        $webhookTestForm->integration_webhook_id = $model->external_hash;
        $events = \yii\helpers\ArrayHelper::map(\lnpay\core\components\ActionComponent::getAvailableTestActionObjects(),'name','display_name');
