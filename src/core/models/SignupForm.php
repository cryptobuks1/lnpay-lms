...
class SignupForm extends Model
{
    ...
    public function rules()
    {
        return [
            ['username', 'trim'],
            //['username', 'required'],
            ['username', 'unique', 'targetClass' => 'lnpay\core\models\User', 'message' => 'This username has already been taken.'],
            ...
            ['email', 'unique', 'targetClass' => 'lnpay\core\models\User', 'message' => 'This email address has already been taken.'],
