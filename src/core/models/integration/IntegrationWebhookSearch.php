...
namespace lnpay\core\models\integration;
...
/**
 * IntegrationWebhookSearch represents the model behind the search form of `lnpay\core\models\integration\IntegrationWebhook`.
 */
