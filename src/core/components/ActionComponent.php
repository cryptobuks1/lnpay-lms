<?php
namespace lnpay\core\components;


use lnpay\core\events\ActionEvent;
use lnpay\core\jobs\IntegrationWebhookRequestJob;
...
use lnpay\core\models\wallet\WalletType;
use lnpay\node\models\LnNode;
...
class ActionComponent extends Component
{
    ...
    public static function registerAction($actionNameId,$data=[],$userObject=null)
    {
        try {
            ...
            $callable = ['\lnpay\core\components\ActionComponent',$event->actionNameObject->name];
